...
class agent():
    def __init__(self, lr, s_size, a_size):
        #These lines established the eed-forward part of the network. The agent takes a state and produces an action.
...
weights = tf.trainable_variables()[0] #The weights we will evalute to look into the network.
...
with tf.Session() as sess:
    ...
    while i < total_episodes:
        s = cBandit.getBandit() #Get state from the Environment
